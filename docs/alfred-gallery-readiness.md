...
|---|---|---|
| Binaries signed and notarised | ⏳ Pending | `.github/workflows/release.yml` has the signing/notarization steps, but no tag has been pushed yet — unverified until a real release ships. Tracked in [#25](https://github.com/y-marui/alfred-password-generator/issues/25) |

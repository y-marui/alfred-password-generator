...
|---|---|---|
| Binaries signed and notarised | ✅ Done | Binary verified signed/notarised in the actual [v1.0.0 release](https://github.com/y-marui/alfred-password-generator/releases/tag/v1.0.0) (`codesign -dvvv`, `spctl -a -vvv -t install`, `gh attestation verify`) |

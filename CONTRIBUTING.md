...
[GitHub Security Advisories](https://github.com/y-marui/alfred-password-generator/security/advisories/new)
...
- **Input sanitization** — Alfred query strings are passed to
  `cmd/password-generator-alfred`; they must not be interpolated into shell
